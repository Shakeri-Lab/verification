...
// Defines the base classes and variants for the button
...
export interface ButtonProps
  ...
  asChild?: boolean // Allows the button to wrap a child component and pass props to it
}

// The Button component itself
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    // If asChild is true, use Slot to pass props to the child, otherwise render a button
